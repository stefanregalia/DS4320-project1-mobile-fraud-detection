...
|-------|-------------|------|
| PaySim: A Financial Mobile Money Simulator for Fraud Detection | Presents the PaySim simulator, describing how it generates synthetic mobile money transaction data based on real financial logs and injects fraudulent behavior for fraud detection research | https://drive.google.com/file/d/1bY-5oyTLp66qnH14zyK8RpbBeCPS_ca5/view?usp=drive_link |
| Fraud Prevention: An Overview | Provides a broad overview of fraud prevention strategies, explaining the types of financial fraud and how institutions detect and respond to them | https://drive.google.com/file/d/1HAiGCKifc09St1hiQlX-fdsIIEd7w_Yn/view?usp=drive_link |
| Fintech Fraud Detection: Techniques, Tools & Solutions | Discusses fraud detection methods used in financial technology, covering common fraud types in mobile payment systems and the tools companies use to combat them | https://drive.google.com/file/d/1qs47jUnSsneqw2GX41GPf1rLM6J0AmEP/view?usp=drive_link |
| Balancing the Scales: A Comprehensive Study on Tackling Class Imbalance in Binary Classification | Evaluates strategies for handling class imbalance in binary classification tasks, comparing SMOTE, class weights, and decision threshold calibration across multiple models and datasets | https://drive.google.com/file/d/1S9aJUvXbWPOOK3vz3Tulii-XrBsWxHn9/view?usp=drive_link |
| Fraud Detection in Mobile Payment Systems using an XGBoost-based Framework | Proposes an XGBoost-based framework for detecting fraud in mobile payment systems | https://drive.google.com/file/d/1ssastNyKIjyObEuVRiWpX2OH9g_Q16RF/view?usp=drive_link |